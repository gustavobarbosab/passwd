object Dependencies {
    ...
    const val navigation_ui = "androidx.navigation:navigation-ui-ktx:${Versions.navigation_ui_ktx}"
    const val navigation_fragment = "androidx.navigation:navigation-fragment-ktx:${Versions.navigation_fragment_ktx}"

    const val lifecycle_extensions = "androidx.lifecycle:lifecycle-extensions:${Versions.lifecycle_extensions}"
    const val lifecycle_compiler = "androidx.lifecycle:lifecycle-compiler:${Versions.lifecycle_compiler}"
    ...
    const val lifecycle_runtime = "androidx.lifecycle:lifecycle-runtime:${Versions.lifecycle_runtime}"
    ...
    const val okhttp_urlconnection = "com.squareup.okhttp3:okhttp-urlconnection:${Versions.okhttp_urlconnection}"
    const val okhttp_logging_interceptor = "com.squareup.okhttp3:logging-interceptor:${Versions.okhttp_loggin_interceptor}"
