object Dependencies {
    ...
    const val lifecycle_runtime =
        "androidx.lifecycle:lifecycle-runtime:${Versions.lifecycle_runtime}"
    ...
    const val retrofit_rx_adapter =
        "com.squareup.retrofit2:adapter-rxjava2:${Versions.retrofit_rx_adapter}"
    const val retrofit_converter_gson =
        "com.squareup.retrofit2:converter-gson:${Versions.retrofit_converter_gson}"
    const val okhttp = "com.squareup.okhttp3:okhttp:${Versions.okhttp}"
    const val okhttp_urlconnection =
        "com.squareup.okhttp3:okhttp-urlconnection:${Versions.okhttp_urlconnection}"
    const val okhttp_logging_interceptor =
        "com.squareup.okhttp3:logging-interceptor:${Versions.okhttp_loggin_interceptor}"
