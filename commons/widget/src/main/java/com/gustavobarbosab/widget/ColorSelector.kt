...
import com.gustavobarbosab.extension.toPx
...
@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private fun getRippleDrawableClick(backgroundDrawable: Drawable?): RippleDrawable =
        RippleDrawable(getPressedState(), backgroundDrawable, null)

    private fun getPressedState(): ColorStateList =
        ColorStateList(arrayOf(intArrayOf(android.R.attr.state_pressed)), intArrayOf(Color.GRAY))
